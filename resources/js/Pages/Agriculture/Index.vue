                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Agricultural Program Organizer</h3>
                                    <p class="mb-4">Juan Dela Cruz has been instrumental in organizing agricultural
                                        programs that promote sustainable farming practices. His efforts in mobilizing
                                        resources and volunteers have greatly benefited the barangay's farming
                                        community.</p>
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Agricultural Education Advocate</h3>
                                    <p class="mb-4">Maria Santos focuses on improving agricultural knowledge and skills
                                        among the farmers. She has spearheaded numerous initiatives to provide training,
                                        enhance farming techniques, and promote sustainable practices.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Agricultural Health Advocate</h3>
                                    <p class="mb-4">Carlos Reyes is dedicated to promoting the health and wellness of
                                        our farmers. He has organized agricultural health camps, vaccination drives, and
                                        wellness programs to ensure the well-being of our farming community.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Youth Agricultural Coordinator</h3>
                                    <p class="mb-4">Anna Mendoza is passionate about empowering the youth in
                                        agriculture. She has established various youth programs that focus on
                                        leadership, skills development, and community service in the agricultural
                                        sector.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Agricultural Disaster Response Officer</h3>
                                    <p class="mb-4">Luis Rivera is responsible for coordinating disaster response and
                                        preparedness efforts in the agricultural sector of the barangay. His proactive
                                        measures have ensured the
                                        safety and resilience of our farming community during emergencies.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                        ...
                        <div class="p-4 md:w-1/3">
                            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img class="lg:h-48 md:h-36 w-full object-cover object-center"
                                    src="/images/agri-programs.webp" alt="news" />
                                <div class="p-6">
                                    ...
                                    <p class="leading-relaxed mb-3">
                                        Participate in our tree planting initiative this Saturday to promote
                                        reforestation and a
                                        greener environment.
                                    </p>
                                </div>
                        ...
                        <div class="p-4 md:w-1/3">
                            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="leading-relaxed mb-3">
                                        Attend our workshop on organic farming techniques to improve crop yield and soil
                                        health
                                        sustainably.
                                    </p>
                                </div>
                        ...
                        <div class="p-4 md:w-1/3">
                            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="leading-relaxed mb-3">
                                        Join us at the upcoming agricultural fair to explore the latest advancements in
                                        farming
