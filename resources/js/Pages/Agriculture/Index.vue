                ...
                <template #cards>
                    <template v-for="member in members" :key="member.id">
                        <template v-if="member.committee.name == 'Agriculture'">
                            <CommitteeMemberCard>
                                <template #image><img
                                        class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4 shadow-lg shadow-teal-600 border-x-2 border-teal-700"
                                ...
                                <template #icons>
                                    <a class="" href="tel:{{ member.contact_number }}" aria-label="Call {{ member.contact_number }}">
