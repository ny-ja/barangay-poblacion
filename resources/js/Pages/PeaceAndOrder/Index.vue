                ...
                <div class="px-5 py-16 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap flex-row-reverse">
                        <img alt="barangay" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded"
                            src="/images/peace-order.webp" />
                        <div class="lg:w-1/2 w-full lg:pr-24 lg:py-6 mt-6 lg:mt-0">
                            <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                                Welcome to the Peace And Order Committee Section
                            </h1>
                            <div class="flex mb-4">
                            ...
                            <p class="leading-relaxed pb-5 border-b-2 border-gray-100 mb-5">
                                Welcome to Barangay Poblacion, where we prioritize peace and order to ensure the safety
                                and
                                well-being of all our residents. Our barangay is committed to maintaining a secure and
                                harmonious
                                environment through various initiatives and programs. Join us in our mission to build a
                                peaceful
                                and orderly community through proactive measures and collaborative efforts.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Peace and Order Program Organizer</h3>
                                    <p class="mb-4">Juan Dela Cruz has been instrumental in organizing programs that
                                        promote
                                        peace and order. His efforts in mobilizing resources and volunteers have greatly
                                        benefited the barangay's security initiatives.</p>
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Community Safety Advocate</h3>
                                    <p class="mb-4">Maria Santos focuses on improving community safety and security. She
                                        has
                                        spearheaded numerous initiatives to provide training, enhance emergency response
                                        skills,
                                        and promote peaceful living.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Public Safety Advocate</h3>
                                    <p class="mb-4">Carlos Reyes is dedicated to promoting the safety and well-being of
                                        our
                                        residents. He has organized safety drills, crime prevention programs, and
                                        community
                                        patrols to ensure the security of our barangay.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                        ...
                        <div class="p-4 lg:w-1/2">
                            <div
                                ...
                                <div class="flex-grow sm:pl-8">
                                    ...
                                    <h3 class="text-gray-500 mb-3">Youth Safety Coordinator</h3>
                                    <p class="mb-4">Anna Mendoza is passionate about empowering the youth in maintaining
                                        peace
                                        and order. She has established various youth programs that focus on leadership,
                                        skills
                                        development, and community service in the context of public safety.</p>
                                    <span class="inline-flex">
                                        <a class="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
