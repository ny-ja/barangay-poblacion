    ...
    <AppLayout title="Peace and order">
        <div class="">
            <template v-for="committee in committees">
                <template v-if="committee.name == 'Peace And Order'">
                    <CommitteeHeader>
            ...
            <CommitteeMemberContainer>
                <template #header>
                    <CommitteeMemberHeader>
                        <template #description>The Barangay Peace and Order Council members are
                            dedicated to enhancing the safety and security of
                            our community. Their unwavering commitment to public
                            service and proactive planning plays a crucial role
                            in maintaining peace and order within our
                            barangay.</template>
                    </CommitteeMemberHeader>
                </template>
                <template #cards>
