    ...
    <AppLayout title="Education">
        <div class="">
            <template v-for="committee in committees">
                <template v-if="committee.name == 'Education'">
                    <CommitteeHeader>
            ...
            <CommitteeMemberContainer>
                <template #header>
                    <CommitteeMemberHeader>
                        <template #description>The Barangay Education Council members are
                            ...
                            ensuring the growth and prosperity of our barangay.</template>
                    </CommitteeMemberHeader>
                </template>
                <template #cards>
                    <template v-for="member in members" :key="member.id">
                        <template v-if="member.committee.name == 'Education'">
                            <CommitteeMemberCard>
                                <template #image><img
