                        ...
                        <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="official in officials.data" :key="official.id"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-500">{{ official.start_date }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500">{{ official.end_date }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                ...
                <div class="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg">
                    <form @submit.prevent="submit" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="form.position" id="position"
